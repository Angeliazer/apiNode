...
router.post('/pedidos/add', jwt.ValidateToken, controllerPedido.AddPedido)
...
router.delete('/clientes/:idCliente', jwt.ValidateToken, controllerCliente.DeleteById)
router.get('/clientes/nome', jwt.ValidateToken, controllerCliente.ListaByNome)

// Rotas de Orcamentos
router.post('/orcamento/add', jwt.ValidateToken, controllerOrcamento.AddOrcamento)
router.put('/orcamentos/update', jwt.ValidateToken, controllerOrcamento.UpdateOrcamento)
router.get('/orcamentos', jwt.ValidateToken, controllerOrcamento.ListaOrcamento)
router.get('/orcamentos/clientes/:idCliente', jwt.ValidateToken, controllerOrcamento.ListaOrcCliente)
router.get('/orcamentos/datas', jwt.ValidateToken, controllerOrcamento.ListaOrcamentoData)
